"""
final_streamlit_fast.py

Faster final Streamlit population projection app.

This version keeps the interface and downloadable outputs of
`final_streamlit_w_additional.py`, but speeds up the projection by doing the
cohort-component simulation with NumPy arrays instead of rebuilding pandas
DataFrames inside every simulation-year loop.
